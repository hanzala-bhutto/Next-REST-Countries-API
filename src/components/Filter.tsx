...
export const Filter = ({filter}: FilterProps) => {
    ...
    return (
        <Dropdown className="w-48 rounded-xl border border-gray-300 bg-white dark:border-gray-600 dark:bg-darkBlueDark dark:text-white" label="Filter by Region" size="lg">
